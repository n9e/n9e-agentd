...
func (m *TestSender) AssertServiceCheck(t *testing.T, checkName string, status metrics.ServiceCheckStatus, hostname string, tags []string, message string) bool {
...
// Additional tags over the ones specified don't make it fail
func (m *TestSender) AssertMetric(t *testing.T, method string, metric string, value float64, hostname string, tags []string) bool {
...
// Additional tags over the ones specified don't make it fail
func (m *TestSender) AssertMonotonicCount(t *testing.T, method string, metric string, value float64, hostname string, tags []string, flushFirstValue bool) bool {
...
// Additional tags over the ones specified don't make it fail
func (m *TestSender) AssertHistogramBucket(t *testing.T, method string, metric string, value int64, lowerBound float64, upperBound float64, monotonic bool, hostname string, tags []string) bool {
...
// Additional tags over the ones specified don't make it fail
func (m *TestSender) AssertMetricInRange(t *testing.T, method string, metric string, min float64, max float64, hostname string, tags []string) bool {
...
// Additional tags over the ones specified don't make it fail
func (m *TestSender) AssertMetricTaggedWith(t *testing.T, method string, metric string, tags []string) bool {
...
func (m *TestSender) AssertMetricNotTaggedWith(t *testing.T, method string, metric string, tags []string) bool {
...
func (m *TestSender) AssertEvent(t *testing.T, expectedEvent metrics.Event, allowedDelta time.Duration) bool {
...
// AggregationKey, Priority, SourceTypeName, EventType, Host and a Ts range weighted with the parameter allowedDelta
func (m *TestSender) AssertEventMissing(t *testing.T, expectedEvent metrics.Event, allowedDelta time.Duration) bool {
