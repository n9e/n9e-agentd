...
type Config struct {
	...
	ApikeyValidationInterval api.Duration         `json:"apikey_validation_interval" flag:"forwarder-apikey-validation-interval" default:"60m" description:"apikeyValidationInterval"` // forwarder_apikey_validation_interval
	...
	StopTimeout              api.Duration         `json:"stop_timeout" flag:"forwarder-stop-timeout" default:"2s" description:"stopTimeout"`                                           // forwarder_stop_timeout
