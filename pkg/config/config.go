...
func NewConfig(configer configer.ParsedConfiger) (*Config, error) {
	cf := DefaultConfig()
	cf.configer = configer
	cf.ValueFiles = configer.ValueFiles()
...
type Config struct {
	...
	//IPCAddress string `json:"ipc_address"` //  -> apiserver.bind_host
	//CmdHost    string `json:"cmd_host"` // cmd_host // -> apiserver.bind_host
	//CmdPort    int    `json:"cmd_port"`      // cmd_port, move to apiserver -> apiserver.bind_port

	// client
	CliQueryTimeout api.Duration `json:"cli_query_timeout" flag:"cli-query-timeout" description:"cli query timeout"`
	DisablePage     bool         `json:"disable_page" flag:"disable-page" env:"AGENTD_DISABLE_PAGE"`
	...
	Lang                   string `json:"lang" flag:"lang" description:"Default lang(zh, en)"`
	EnableN9eProvider      bool   `json:"enable_n9e_provider" flag:"enable-n9e-provider" description:"enable n9e server api as autodiscovery provider"`
	PayloadProcessorConfig string `json:"payload_processor_config"`

	//N9eSeriesFormat   bool     `json:"n9e_series_format"`                                                                                               // the payload format for forwarder
	Endpoints []string `json:"endpoints" flag:"endpoints" env:"N9E_ENDPOINTS" description:"endpoints addresses of n9e server"` // site, dd_url
	...
	ContainerdNamespace   string    `json:"containerd_namespace"`    // containerd_namespace
	...
	VerboseReport           bool                                `json:"verbose_report"`            // collects run in verbose mode, e.g. report both with cpu.used(sys+user), cpu.system & cpu.user
	...
	CoreDump                         bool              `json:"core_dump"`                                                                                    // go_core_dump
	HealthPort                       int               `json:"health_port"`                                                                                  // health_port
	SkipSSLValidation                bool              `json:"skip_ssl_validation"`                                                                          // skip_ssl_validation
	ForceTLS12                       bool              `json:"force_tls_12"`                                                                                 // force_tls_12
	ECSMetadataTimeout               api.Duration      `json:"ecs_metadata_timeout" flag:"ecs-metadata-timeout" description:"ecs metadata timeout"`          // ecs_metadata_timeout
	MetadataEndpointsMaxHostnameSize int               `json:"metadata_endpoints_max_hostname_size"`                                                         // metadata_endpoints_max_hostname_size
	CloudProviderMetadata            []string          `json:"cloud_provider_metadata"`                                                                      //cloud_provider_metadata
	GCEMetadataTimeout               api.Duration      `json:"gce_metadata_timeout" flag:"gce-metadata-timeout" description:"gce metadata timeout"`          // gce_metadata_timeout
	...
	CollectGCETags                   bool              `json:"collect_gce_tags"`                                                                             // collect_gce_tags
	...
	EnableGohai                      bool              `json:"enable_gohai"`                                                                                 // enable_gohai
	ChecksTagCardinality             string            `json:"checks_tag_cardinality"`                                                                       // checks_tag_cardinality
	HistogramAggregates              []string          `json:"histogram_aggregates"`                                                                         // histogram_aggregates
	HistogramPercentiles             []string          `json:"histogram_percentiles"`                                                                        // histogram_percentiles
	AcLoadTimeout                    api.Duration      `json:"ac_load_timeout" flag:"ac-load-timeout" description:"ac load timeout"`                         // ac_load_timeout
	AdConfigPollInterval             api.Duration      `json:"ad_config_poll_interval" flag:"ac-config-poll-interval" description:"ac config poll interval"` // ad_config_poll_interval

	// aggregator
	AggregatorBufferSize  int          `json:"aggregator_buffer_size"`                                                                       // aggregator_buffer_size
	AggregatorStopTimeout api.Duration `json:"aggregator_stop_timeout" flag:"aggregator-stop-timeout" description:"aggregator stop timeout"` // aggregator_stop_timeout
	...
	AutoconfTemplateUrlTimeout     int    `json:"autoconf_template_url_timeout"`                                    // autoconf_template_url_timeout
	CheckRunners                   int    `json:"check_runners"`                                                    // check_runners
	...
	CacheSyncTimeout api.Duration `json:"cache_sync_timeout" flag:"cache-sync-timeout" description:"cache sync timeout"` // cache_sync_timeout
	...
	CriConnectionTimeout         api.Duration `json:"cri_connection_timeout" flag:"cri-connection-timeout" description:"cri connection timeout"`                 // cri_connection_timeout
	CriQueryTimeout              api.Duration `json:"cri_query_timeout" flag:"cri-query-timeout" description:"cri query timeout"`                                // cri_query_timeout
	...
	DockerQueryTimeout           api.Duration `json:"docker_query_timeout" flag:"docker-query-timeout" description:"docker query timeout"`                       // docker_query_timeout
	EC2PreferImdsv2              bool         `json:"ec2_prefer_imdsv2"`                                                                                         // ec2_prefer_imdsv2
	EC2MetadataTimeout           api.Duration `json:"ec2_metadata_timeout" falg:"ec2-metadata-timeout" description:"ec2 metadata timeout"`                       // ec2_metadata_timeout
	EC2MetadataTokenLifetime     api.Duration `json:"ec2_metadata_token_lifetime" falg:"ec2-metadata-token-lifetime"  description:"ec2 metadata token lifetime"` // ec2_metadata_token_lifetime
	EC2UseWindowsPrefixDetection bool         `json:"ec2_use_windows_prefix_detection"`                                                                          // ec2_use_windows_prefix_detection
	EcsAgentContainerName        string       `json:"ecs_agent_container_name"`                                                                                  // ecs_agent_container_name
	...
	EnableMetadataCollection     bool         `json:"enable_metadata_collection"`                                                                                // enable_metadata_collection

	ExcludeGCETags []string `json:"exclude_gce_tags"` // exclude_gce_tags

	ExternalMetricsAggregator        string            `json:"external_metrics_aggregator"`                                                                                                            // external_metrics.aggregator
	...
	HpaConfigmapName                 string            `json:"hpa_configmap_name"`                                                                                                                     // hpa_configmap_name
	HpaWatcherGcPeriod               api.Duration      `json:"hpa_watcher_gc_period" flag:"hpa-watcher-gc-period" description:"hpa_watcher_gcPeriod"`                                                  // hpa_watcher_gc_period
	IgnoreAutoconf                   []string          `json:"ignore_autoconf"`                                                                                                                        // ignore_autoconf
	InventoriesEnabled               bool              `json:"inventories_enabled"`                                                                                                                    // inventories_enabled
	InventoriesMaxInterval           api.Duration      `json:"inventories_max_interval" flag:"inventories-max-interval" description:"inventoriesMaxInterval"`                                          // inventories_max_interval
	InventoriesMinInterval           api.Duration      `json:"inventories_min_interval" flag:"inventories-min-interval" description:"inventoriesMinInterval"`                                          // inventories_min_interval
	KubeResourcesNamespace           bool              `json:"kube_resources_namespace"`                                                                                                               // kube_resources_namespace
	KubeletCachePodsDuration         api.Duration      `json:"kubelet_cache_pods_duration" flag:"kubelet-cache-pods-duration" description:"kubeletCachePodsDuration"`                                  // kubelet_cache_pods_duration
	...
	KubeletListenerPollingInterval   api.Duration      `json:"kubelet_listener_polling_interval" flag:"kubelet-listener-polling-interval" description:"kubeletListenerPollingInterval"`                // kubelet_listener_polling_interval
	KubeletTlsVerify                 bool              `json:"kubelet_tls_verify"`                                                                                                                     // kubelet_tls_verify
	...
	KubernetesApiserverClientTimeout int               `json:"kubernetes_apiserver_client_timeout" flag:"kubernetes-apiserver-client-timeout" escription:"kubernetes_apiserverClientTimeout(Seconde)"` // kubernetes_apiserver_client_timeout
	KubernetesApiserverUseProtobuf   bool              `json:"kubernetes_apiserver_use_protobuf"`                                                                                                      // kubernetes_apiserver_use_protobuf
	KubernetesCollectMetadataTags    bool              `json:"kubernetes_collect_metadata_tags"`                                                                                                       // kubernetes_collect_metadata_tags
	KubernetesCollectServiceTags     bool              `json:"kubernetes_collect_service_tags"`                                                                                                        // kubernetes_collect_service_tags
	KubernetesHttpKubeletPort        int               `json:"kubernetes_http_kubelet_port"`                                                                                                           // kubernetes_http_kubelet_port
	KubernetesHttpsKubeletPort       int               `json:"kubernetes_https_kubelet_port"`                                                                                                          // kubernetes_https_kubelet_port
	KubernetesInformersResyncPeriod  api.Duration      `json:"kubernetes_informers_resync_period" flag:"kubernetes-informers-resync-period" description:"kubernetesInformersResyncPeriod"`             // kubernetes_informers_resync_period
	...
	KubernetesMetadataTagUpdateFreq  api.Duration      `json:"kubernetes_metadata_tag_update_freq" flag:"kubernetes-metadata-tag-update-freq" description:"kubernetesMetadataTagUpdateFreq"`           // kubernetes_metadata_tag_update_freq
	...
	KubernetesPodExpirationDuration  api.Duration      `json:"kubernetes_pod_expiration_duration" flag:"kubernetes-pod-expiration-duration" description:"kubernetes_podExpirationDuration"`            // kubernetes_pod_expiration_duration
	...
	LeaderLeaseDuration              api.Duration      `json:"leader_lease_duration" flag:"leader-lease-duration" description:"leader lease duration"`                                                 // leader_lease_duration

	// log
	LoggingFrequency   int64    `json:"logging_frequency"` // logging_frequency
	...
	LogLevel           string   `json:"log_level" flag:"log-level" description:"info, debug"`
	LogToConsole       bool     `json:"log_to_console" flag:"log-to-console"`
	...
	MetricsPort               int           `json:"metrics_port"`                  // metrics_port
	ProcRoot                  string        `json:"proc_root"`                     // proc_root
	...
	// python
	Python3LinterTimeout             api.Duration `json:"python3_linter_timeout" flag:"python3-linter-timeout" description:"python3LinterTimeout"` // python3_linter_timeout
	...
	// serializer
	EnableJsonStreamSharedCompressorBuffers       bool           `json:"enable_json_stream_shared_compressor_buffers"`                                                    //enable_json_stream_shared_compressor_buffers
	EnablePayloads                                EnablePayloads `json:"enable_payloads"`                                                                                 // enable_payloads.*
	SerializerMaxPayloadSize                      int            `json:"serializer_max_payload_size" description:"serializer_max_payload_size"`                           // serializer_max_payload_size
	SerializerMaxUncompressedPayloadSize          int            `json:"serializer_max_uncompressed_payload_size" description:"serializer_max_uncompressed_payload_size"` // serializer_max_uncompressed_payload_size
	EnableStreamPayloadSerialization              bool           `json:"enable_stream_payload_serialization"`
	EnableServiceChecksStreamPayloadSerialization bool           `json:"enable_service_checks_stream_payload_serialization"`
	EnableEventsStreamPayloadSerialization        bool           `json:"enable_events_stream_payload_serialization"`
	EnableSketchStreamPayloadSerialization        bool           `json:"enable_sketch_stream_payload_serialization"`

	//ServerTimeout api.Duration               `json:"server_timeout" flag:"server-timeout" description:"server_timeout"` // server_timeout, move to apiserver
	...
	AzureHostnameStyle            string       `json:"azure_hostname_style"`
	...
	SecretBackendTimeout                   int      `json:"secret_backend_timeout"`
	SecretBackendOutputMaxSize             int      `json:"secret_backend_output_max_size"`
...
func (p *Config) Validate() error {
	...
	if p.SecretBackendCommand != "" {
		if err := ResolveSecrets(p); err != nil {
			return err
		}
	}
...
type ProcessConfig struct {
	...
	ExpvarPort           int      `json:"expvar_port"` // process_config.expvar_port
	ScrubArgs            bool     `json:"scrub_args"`
	...
	QueueBytes                resource.Quantity `json:"queue_bytes"` // process_queue_bytes
	MaxPerMessage             int               `json:"max_per_message"`
	MaxCtrProcessesPerMessage int               `json:"max_ctr_procs_per_message"`
	GrpcConnectionTimeout     api.Duration      `json:"grpc_connection_timeout"`
...
type ProcessWindows struct {
	ArgsRefreshInterval int  `json:"args_refresh_interval" description:"Sets windows process table refresh rate (in number of check runs)"`
	AddNewArgs          bool `json:"add_new_args" description:"Controls getting process arguments immediately when a new process is discovered"`
}
...
type EnablePayloads struct {
	Series              bool `json:"series"`               // enable_payloads.series
	Events              bool `json:"events"`               // enable_payloads.events
	ServiceChecks       bool `json:"service_checks"`       // enable_payloads.service_checks
	Sketches            bool `json:"sketches"`             // enable_payloads.sketches
	JsonToV1Intake      bool `json:"json_to_v1_intake"`    // enable_payloads.json_to_v1_intake
	Metadata            bool `json:"metadata"`             //
	HostMetadata        bool `json:"host_metadata"`        //
	AgentchecksMetadata bool `json:"agentchecks_metadata"` //
}
...
type ExternalMetricsProvider struct {
	...
	BucketSize           int          `json:"bucket_size"`                                                                                                         // external_metrics_provider.bucket_size
	Enabled              bool         `json:"enabled"`                                                                                                             // external_metrics_provider.enabled
	LocalCopyRefreshRate api.Duration `json:"local_copy_refresh_rate" flag:"external-metrics-provider-local-copy-refresh-rate" description:"localCopyRefreshRate"` // external_metrics_provider.local_copy_refresh_rate
	MaxAge               int          `json:"max_age"`                                                                                                             // external_metrics_provider.max_age
	RefreshPeriod        int          `json:"refresh_period"`                                                                                                      // external_metrics_provider.refresh_period
	Rollup               int          `json:"rollup"`                                                                                                              // external_metrics_provider.rollup
...
type AdminssionController struct {
	...
	CertificateExpirationThreshold api.Duration `json:"certificate_expiration_threshold" flag:"admission-controller-certificate-expiration-threshold" description:"certificateExpirationThreshold"` // admission_controller.certificate.expiration_threshold
	CertificateSecretName          string       `json:"certificate_secret_name"`                                                                                                                    // admission_controller.certificate.secret_name
	CertificateValidityBound       api.Duration `json:"certificate_validity_bound" flag:"admission-controller-certificate-validity-bound" description:"certificateValidityBound"`                   // admission_controller.certificate.validity_bound
	InjectConfigEnabled            bool         `json:"inject_config_enabled"`                                                                                                                      // admission_controller.inject_config.enabled
	InjectConfigEndpoint           string       `json:"inject_config_endpoint"`                                                                                                                     // admission_controller.inject_config.endpoint
	InjectTagsEnabled              bool         `json:"inject_tags_enabled"`                                                                                                                        // admission_controller.inject_tags.enabled
	InjectTagsEndpoint             string       `json:"inject_tags_endpoint"`                                                                                                                       // admission_controller.inject_tags.endpoint
	MutateUnlabelled               bool         `json:"mutate_unlabelled"`                                                                                                                          // admission_controller.mutate_unlabelled
	PodOwnersCacheValidity         int          `json:"pod_owners_cache_validity" description:"Minute"`                                                                                             // admission_controller.pod_owners_cache_validity
	ServiceName                    string       `json:"service_name"`                                                                                                                               // admission_controller.service_name
	TimeoutSeconds                 api.Duration `json:"timeout_seconds" flag:"adminssion-controller-timeout" description:"timeoutSeconds"`                                                          // admission_controller.timeout_seconds
	WebhookName                    string       `json:"webhook_name"`                                                                                                                               // admission_controller.webhook_name
...
type Jmx struct {
	...
	CollectionTimeout          api.Duration `json:"collection_timeout" flag:"jmx-collection-timeout" description:"collectionTimeout"`       // jmx_collection_timeout
	...
	MaxRestarts                int          `json:"max_restarts"`                                                                           // jmx_max_restarts
	ReconnectionThreadPoolSize int          `json:"reconnection_thread_pool_size"`                                                          // jmx_reconnection_thread_pool_size
	ReconnectionTimeout        api.Duration `json:"reconnection_timeout" flag:"jmx-reconnection-timeout" description:"reconnectionTimeout"` // jmx_reconnection_timeout
	RestartInterval            api.Duration `json:"restart_interval" flag:"jmx-restart-interval" description:"restartInterval(Second)"`     // jmx_restart_interval
	ThreadPoolSize             int          `json:"thread_pool_size"`                                                                       // jmx_thread_pool_size
...
type CloudFoundryGarden struct {
	ListenNetwork string `json:"listen_network"` // cloud_foundry_garden.listen_network
	ListenAddress string `json:"listen_address"` // cloud_foundry_garden.listen_address
}
...
type NetworkConfig struct {
	Enabled              bool `json:"enabled"`                 // network_config.enabled"
...
type Telemetry struct {
	Enabled bool     `json:"enabled"` // telemetry.enabled
	Port    int      `json:"port"`    // expvar_port
	Docs    bool     `json:"docs"`    // /docs/*
	Metrics bool     `json:"metrics"` // /metrics/
	Expvar  bool     `json:"expvar"`  // /vars
	Pprof   bool     `json:"pprof"`   // /debug/pprof
...
type TelemetryStatsd struct {
	AggregatorChannelLatencyBuckets []float64 `json:"aggregator_channel_latency_buckets"`
	ListenersLatencyBuckets         []float64 `json:"listeners_latency_buckets"`
	ListenersChannelLatencyBuckets  []float64 `json:"listeners_channel_latency_buckets"`
}
type ClusterChecks struct {
	ClcRunnersPort             int          `json:"clc_runners_port"`                                                                               // cluster_checks.clc_runners_port
	AdvancedDispatchingEnabled bool         `json:"advanced_dispatching_enabled"`                                                                   // cluster_checks.advanced_dispatching_enabled
	ClusterTagName             string       `json:"cluster_tag_name"`                                                                               // cluster_checks.cluster_tag_name
	Enabled                    bool         `json:"enabled"`                                                                                        // cluster_checks.enabled
	ExtraTags                  []string     `json:"extra_tags"`                                                                                     // cluster_checks.extra_tags
	NodeExpirationTimeout      api.Duration `json:"node_expiration_timeout" flag:"clc-node-expiration-timeout" description:"nodeExpirationTimeout"` // cluster_checks.node_expiration_timeout
	WarmupDuration             api.Duration `json:"warmup_duration" flag:"clc-warmup-duration" description:"warmupDuration"`                        // cluster_checks.warmup_duration
...
type ClusterAgent struct {
	...
	CmdPort               int    `json:"cmd_port"`                // cluster_agent.cmd_port
	Enabled               bool   `json:"enabled"`                 // cluster_agent.enabled
	KubernetesServiceName string `json:"kubernetes_service_name"` // cluster_agent.kubernetes_service_name
...
type OrchestratorExplorer struct { // orchestrator_explorer
	Enabled                   bool                `json:"enabled"`                     // orchestrator_explorer.enabled
...
type Autoconfig struct {
	Enabled         bool     `json:"enabled"`          // autoconfig_from_environment
