...
import "github.com/n9e/n9e-agentd/pkg/api"
...
type Config struct {
	...
	ContextExpirySeconds     api.Duration     `json:"context_expiry_seconds" flag:"statsd-context-expiry-seconds" default:"300s" description:"contextExpirySeconds"` // dogstatsd_context_expiry_seconds
	ExpirySeconds            api.Duration     `json:"expiry_seconds" flag:"statsd-expiry-seconds" default:"300s" description:"expirySeconds"`                        // dogstatsd_expiry_seconds
	...
	PacketBufferFlushTimeout api.Duration `json:"packet_buffer_flush_timeout" flag:"statsd-packet-buffer-flush-timeout" default:"100ms" description:"packetBufferFlushTimeout"` // dogstatsd_packet_buffer_flush_timeout
