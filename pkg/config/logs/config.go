...
type Config struct {
	...
	FileScanPeriod              api.Duration      `json:"file_scan_period" description:"file scan period"` // logs_config.file_scan_period
	ValidatePodContainerId      bool              `json:"validate_pod_container_id"`
	...
	DevModeUseProto             bool              `json:"dev_mode_use_proto"`                                                                                            // logs_config.dev_mode_use_proto
	ConnectionResetInterval     api.Duration      `json:"connection_reset_interval" flag:"logs-connection-reset-interval" description:"connectionResetInterval(Second)"` // logs_config.connection_reset_interval
	...
	UseCompression              bool              `json:"use_compression"`                                                                                               // logs_config.use_compression
	CompressionLevel            int               `json:"compression_level"`                                                                                             // logs_config.compression_level
	URL                         string            `json:"url"`                                                                                                           // logs_config.dd_url (e.g. localhost:8080)
	BatchWait                   api.Duration      `json:"batch_wait" flag:"logs-batch-wait" description:"batchWait"`                                                     // logs_config.batch_wait
	...
	SenderBackoffFactor         float64           `json:"sender_backoff_factor"`
	SenderBackoffBase           float64           `json:"sender_backoff_base"`
	SenderBackoffMax            float64           `json:"sender_backoff_max"`
	SenderRecoveryInterval      int               `json:"sender_recovery_interval"`
	...
	AggregationTimeout          api.Duration      `json:"aggregation_timeout" flag:"logs-aggregation-timeout" description:"aggregationTimeout"`                    // logs_config.aggregation_timeout
	CloseTimeout                api.Duration      `json:"close_timeout" flag:"logs-close-timeout" description:"closeTimeout"`                                      // logs_config.close_timeout
	...
	OpenFilesLimit              int               `json:"open_files_limit" flag:"logs-open-files-limit"`                                                           // logs_config.open_files_limit
	...
	DockerClientReadTimeout     api.Duration      `json:"docker_client_read_timeout" flag:"logs-docker-client-read-timeout" description:"dockerClientReadTimeout"` // logs_config.docker_client_read_timeout
	FrameSize                   int               `json:"frame_size"`                                                                                              // logs_config.frame_size
	StopGracePeriod             api.Duration      `json:"stop_grace_period" flag:"logs-stop-grace-period" description:"stopGracePeriod"`                           // logs_config.stop_grace_period
