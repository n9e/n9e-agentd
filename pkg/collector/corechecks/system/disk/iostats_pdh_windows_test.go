...
import (
	...
	pdhtest "github.com/n9e/n9e-agentd/staging/datadog-agent/pkg/util/winutil/pdhutil"
)
...
func TestIoCheckWindows(t *testing.T) {
	...
	mock.On("Gauge", "system.io.wb_s", 1.222, "", []string{"device:C:"}).Return().Times(1)
	mock.On("Gauge", "system.io.wb_s", 1.333, "", []string{"device:HarddiskVolume1", "device_name:HarddiskVolume1"}).Return().Times(1)
	...
	mock.On("Gauge", "system.io.rb_s", 3.222, "", []string{"device:C:"}).Return().Times(1)
	mock.On("Gauge", "system.io.rb_s", 3.333, "", []string{"device:HarddiskVolume1", "device_name:HarddiskVolume1"}).Return().Times(1)
...
func TestIoCheckInstanceAdded(t *testing.T) {
	...
	mock.On("Gauge", "system.io.wb_s", 1.222, "", []string{"device:C:"}).Return().Times(2)
	mock.On("Gauge", "system.io.wb_s", 1.333, "", []string{"device:HarddiskVolume1", "device_name:HarddiskVolume1"}).Return().Times(2)
	...
	mock.On("Gauge", "system.io.rb_s", 3.222, "", []string{"device:C:"}).Return().Times(2)
	mock.On("Gauge", "system.io.rb_s", 3.333, "", []string{"device:HarddiskVolume1", "device_name:HarddiskVolume1"}).Return().Times(2)
	...
	mock.On("Gauge", "system.io.wb_s", 1.444, "", []string{"device:Y:"}).Return().Times(1)
	mock.On("Gauge", "system.io.wb_s", 1.555, "", []string{"device:HarddiskVolume2", "device_name:HarddiskVolume2"}).Return().Times(1)
	...
	mock.On("Gauge", "system.io.rb_s", 3.444, "", []string{"device:Y:"}).Return().Times(1)
	mock.On("Gauge", "system.io.rb_s", 3.555, "", []string{"device:HarddiskVolume2", "device_name:HarddiskVolume2"}).Return().Times(1)
...
func TestIoCheckInstanceRemoved(t *testing.T) {
	...
	mock.On("Gauge", "system.io.wb_s", 1.222, "", []string{"device:C:"}).Return().Times(3)
	mock.On("Gauge", "system.io.wb_s", 1.333, "", []string{"device:HarddiskVolume1", "device_name:HarddiskVolume1"}).Return().Times(3)
	...
	mock.On("Gauge", "system.io.rb_s", 3.222, "", []string{"device:C:"}).Return().Times(3)
	mock.On("Gauge", "system.io.rb_s", 3.333, "", []string{"device:HarddiskVolume1", "device_name:HarddiskVolume1"}).Return().Times(3)
