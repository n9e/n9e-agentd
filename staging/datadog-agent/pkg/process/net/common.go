...
import (
	...
	netEncoding "github.com/n9e/n9e-agentd/staging/datadog-agent/pkg/network/encoding"
	procEncoding "github.com/n9e/n9e-agentd/staging/datadog-agent/pkg/process/encoding"
	"k8s.io/klog/v2"
...
func GetRemoteSystemProbeUtil() (*RemoteSysProbeUtil, error) {
	...
	if err := globalUtil.initRetry.TriggerRetry(); err != nil {
		klog.V(5).Infof("system probe init error: %s", err)
		return nil, err
	}
