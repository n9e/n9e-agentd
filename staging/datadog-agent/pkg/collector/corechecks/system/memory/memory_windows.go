...
func (c *Check) Run() error {
	...
	if c.cacheBytes != nil {
		...
		if err == nil {
			...
			klog.Warningf("Could not retrieve value for system.mem.cached %v", err)
		}
	}
	...
	if c.committedBytes != nil {
		...
		if err == nil {
			...
			klog.Warningf("Could not retrieve value for system.mem.committed %v", err)
		}
	}
	...
	if c.pagedBytes != nil {
		...
		if err == nil {
			...
			klog.Warningf("Could not retrieve value for system.mem.paged %v", err)
		}
	}
	...
	if c.nonpagedBytes != nil {
		...
		if err == nil {
			...
			klog.Warningf("Could not retrieve value for system.mem.nonpaged %v", err)
		}
	}
