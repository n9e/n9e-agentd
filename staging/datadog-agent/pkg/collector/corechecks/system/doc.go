...
func init() {
	...
	metrics.Register("system.disk.free", "gauge", "Shown as kilobyte")
	...
	metrics.Register("system.disk.total", "gauge", "Shown as kilobyte")
	metrics.Register("system.disk.used", "gauge", "Shown as kilobyte")
