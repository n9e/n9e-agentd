...
func registerMetric() {
	...
	m.Register("system.cpu.num_cores", "gauge")
	m.Register("system.cpu.stolen", "gauge", "Shown as percent")
	m.Register("system.cpu.system", "gauge", "Shown as percent")
	m.Register("system.cpu.user", "gauge", "Shown as percent")
	m.Register("system.fs.file_handles.allocated", "gauge", "Shown as file")
	m.Register("system.fs.file_handles.allocated_unused", "gauge", "Shown as file")
	m.Register("system.fs.file_handles.in_use", "gauge", "Shown as percent")
	m.Register("system.fs.file_handles.max", "gauge", "Shown as file")
	m.Register("system.fs.file_handles.used", "gauge", "Shown as file")
	m.Register("system.fs.inodes.free", "gauge", "Shown as inode")
	m.Register("system.fs.inodes.in_use", "gauge", "Shown as percent")
	m.Register("system.fs.inodes.total", "gauge", "Shown as inode")
	m.Register("system.fs.inodes.used", "gauge", "Shown as inode")
	m.Register("system.io.avg_q_sz", "gauge", "Shown as request")
	m.Register("system.io.avg_rq_sz", "gauge", "Shown as sector")
	...
	m.Register("system.load.5", "gauge")
	m.Register("system.load.norm.1", "gauge")
	m.Register("system.load.norm.15", "gauge")
	m.Register("system.load.norm.5", "gauge")
	m.Register("system.mem.buffered", "gauge", "Shown as megabyte")
	m.Register("system.mem.cached", "gauge", "Shown as megabyte")
	m.Register("system.mem.commit_limit", "gauge", "Shown as megabyte")
	m.Register("system.mem.committed", "gauge", "Shown as megabyte")
	m.Register("system.mem.committed_as", "gauge", "Shown as megabyte")
	m.Register("system.mem.free", "gauge", "Shown as megabyte")
	m.Register("system.mem.nonpaged", "gauge", "Shown as megabyte")
	m.Register("system.mem.page_free", "gauge", "Shown as megabyte")
	m.Register("system.mem.page_tables", "gauge", "Shown as megabyte")
	m.Register("system.mem.page_total", "gauge", "Shown as megabyte")
	m.Register("system.mem.page_used", "gauge", "Shown as megabyte")
	m.Register("system.mem.paged", "gauge", "Shown as megabyte")
	m.Register("system.mem.pagefile.free", "gauge", "Shown as megabyte")
	m.Register("system.mem.pagefile.pct_free", "gauge", "Shown as percent")
	m.Register("system.mem.pagefile.total", "gauge", "Shown as megabyte")
	m.Register("system.mem.pagefile.used", "gauge", "Shown as megabyte")
	m.Register("system.mem.pct_usable", "gauge", "Shown as percent")
	m.Register("system.mem.pct_used", "gauge", "Shown as percent")
	m.Register("system.mem.shared", "gauge", "Shown as megabyte")
	m.Register("system.mem.slab", "gauge", "Shown as megabyte")
	m.Register("system.mem.total", "gauge", "Shown as megabyte")
	m.Register("system.mem.usable", "gauge", "Shown as megabyte")
	m.Register("system.mem.used", "gauge", "Shown as megabyte")
	m.Register("system.proc.count", "gauge", "Shown as process")
	m.Register("system.proc.queue_length", "gauge", "Shown as thread")
	m.Register("system.swap.cached", "gauge", "Shown as megabyte")
	m.Register("system.swap.free", "gauge", "Shown as megabyte")
	m.Register("system.swap.pct_free", "gauge", "Shown as percent")
