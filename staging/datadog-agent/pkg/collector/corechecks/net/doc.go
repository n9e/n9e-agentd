...
func registerMetric() {
	...
	m.Register("system.net.aws.ec2.linklocal_allowance_exceeded", "gauge", "Shown as packet")
	m.Register("system.net.aws.ec2.pps_allowance_exceeded", "gauge", "Shown as packet")
	m.Register("system.net.bytes_rcvd", "gauge", "Shown as byte")
	m.Register("system.net.bytes_sent", "gauge", "Shown as byte")
	m.Register("system.net.conntrack.acct", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.buckets", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.checksum", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.count", "gauge", "Shown as connection")
	m.Register("system.net.conntrack.drop", "count", "Shown as unit")
	m.Register("system.net.conntrack.early_drop", "count", "Shown as unit")
	m.Register("system.net.conntrack.error", "count", "Shown as unit")
	m.Register("system.net.conntrack.events", "count", "Shown as unit")
	m.Register("system.net.conntrack.events_retry_timeout", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.expect_max", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.found", "count", "Shown as unit")
	m.Register("system.net.conntrack.generic_timeout", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.helper", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.icmp_timeout", "gauge", "Shown as second")
	m.Register("system.net.conntrack.ignore", "count", "Shown as unit")
	m.Register("system.net.conntrack.insert", "count", "Shown as unit")
	m.Register("system.net.conntrack.insert_failed", "count", "Shown as unit")
	m.Register("system.net.conntrack.invalid", "count", "Shown as unit")
	m.Register("system.net.conntrack.log_invalid", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.max", "gauge", "Shown as connection")
	m.Register("system.net.conntrack.search_restart", "count", "Shown as unit")
	m.Register("system.net.conntrack.tcp_be_liberal", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.tcp_loose", "gauge", "Shown as unit")
	m.Register("system.net.conntrack.tcp_max_retrans", "gauge", "Shown as packet")
	m.Register("system.net.conntrack.tcp_timeout", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_close", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_close_wait", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_established", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_fin_wait", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_last_ack", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_max_retrans", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_stream", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_syn_recv", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_syn_sent", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_time_wait", "gauge", "Shown as second")
	m.Register("system.net.conntrack.tcp_timeout_unacknowledged", "gauge", "Shown as second")
	m.Register("system.net.conntrack.timestamp", "gauge", "Shown as unit")
	m.Register("system.net.packets_in.count", "gauge", "Shown as packet")
	m.Register("system.net.packets_in.error", "gauge", "Shown as error")
	m.Register("system.net.packets_out.count", "gauge", "Shown as packet")
	m.Register("system.net.packets_out.error", "gauge", "Shown as error")
	m.Register("system.net.tcp.backlog_drops", "gauge", "Shown as packet")
	m.Register("system.net.tcp.backlog_drops.count", "count", "Shown as packet")
	m.Register("system.net.tcp.failed_retransmits.count", "count", "Shown as packet")
	m.Register("system.net.tcp.in_segs", "gauge", "Shown as segment")
	m.Register("system.net.tcp.in_segs.count", "count", "Shown as segment")
	m.Register("system.net.tcp.listen_drops", "gauge")
	m.Register("system.net.tcp.listen_drops.count", "count")
	m.Register("system.net.tcp.listen_overflows", "gauge")
	m.Register("system.net.tcp.listen_overflows.count", "count")
	m.Register("system.net.tcp.out_segs", "gauge", "Shown as segment")
	m.Register("system.net.tcp.out_segs.count", "count", "Shown as segment")
	m.Register("system.net.tcp.rcv_packs", "gauge", "Shown as packet")
	m.Register("system.net.tcp.recv_q.95percentile", "gauge", "Shown as byte")
	m.Register("system.net.tcp.recv_q.avg", "gauge", "Shown as byte")
	m.Register("system.net.tcp.recv_q.count", "rate", "Shown as connection")
	m.Register("system.net.tcp.recv_q.max", "gauge", "Shown as byte")
	m.Register("system.net.tcp.recv_q.median", "gauge", "Shown as byte")
	m.Register("system.net.tcp.retrans_packs", "gauge", "Shown as packet")
	m.Register("system.net.tcp.retrans_segs", "gauge", "Shown as segment")
	m.Register("system.net.tcp.retrans_segs.count", "count", "Shown as segment")
	m.Register("system.net.tcp.send_q.95percentile", "gauge", "Shown as byte")
	m.Register("system.net.tcp.send_q.avg", "gauge", "Shown as byte")
	m.Register("system.net.tcp.send_q.count", "rate", "Shown as connection")
	m.Register("system.net.tcp.send_q.max", "gauge", "Shown as byte")
	m.Register("system.net.tcp.send_q.median", "gauge", "Shown as byte")
	m.Register("system.net.tcp.sent_packs", "gauge", "Shown as packet")
	m.Register("system.net.tcp4.closing", "gauge", "Shown as connection")
	m.Register("system.net.tcp4.established", "gauge", "Shown as connection")
	m.Register("system.net.tcp4.listening", "gauge", "Shown as connection")
	m.Register("system.net.tcp4.opening", "gauge", "Shown as connection")
	m.Register("system.net.tcp6.closing", "gauge", "Shown as connection")
	m.Register("system.net.tcp6.established", "gauge", "Shown as connection")
	m.Register("system.net.tcp6.listening", "gauge", "Shown as connection")
	m.Register("system.net.tcp6.opening", "gauge", "Shown as connection")
	m.Register("system.net.udp.in_datagrams", "gauge", "Shown as datagram")
	m.Register("system.net.udp.in_datagrams.count", "count", "Shown as datagram")
	m.Register("system.net.udp.in_errors", "gauge", "Shown as datagram")
	m.Register("system.net.udp.in_errors.count", "count", "Shown as datagram")
	m.Register("system.net.udp.no_ports", "gauge", "Shown as datagram")
	m.Register("system.net.udp.no_ports.count", "count", "Shown as datagram")
	m.Register("system.net.udp.out_datagrams", "gauge", "Shown as datagram")
	m.Register("system.net.udp.out_datagrams.count", "count", "Shown as datagram")
	m.Register("system.net.udp.rcv_buf_errors", "gauge", "Shown as error")
	m.Register("system.net.udp.rcv_buf_errors.count", "count", "Shown as error")
	m.Register("system.net.udp.snd_buf_errors", "gauge", "Shown as error")
}
