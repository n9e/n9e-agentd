...
type provider struct {
	...
	processingRules           []*logs.ProcessingRule
	endpoints                 *logs.Endpoints
...
func NewProvider(numberOfPipelines int, auditor auditor.Auditor, diagnosticMessageReceiver diagnostic.MessageReceiver, processingRules []*logs.ProcessingRule, endpoints *logs.Endpoints, destinationsContext *client.DestinationsContext) Provider {
...
func NewServerlessProvider(numberOfPipelines int, auditor auditor.Auditor, processingRules []*logs.ProcessingRule, endpoints *logs.Endpoints, destinationsContext *client.DestinationsContext) Provider {
...
func newProvider(numberOfPipelines int, auditor auditor.Auditor, diagnosticMessageReceiver diagnostic.MessageReceiver, processingRules []*logs.ProcessingRule, endpoints *logs.Endpoints, destinationsContext *client.DestinationsContext, serverless bool) Provider {
	return &provider{
